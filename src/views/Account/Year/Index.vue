<template>
  <v-ons-page>
    <page-toolbar :title="title"></page-toolbar>
      <data-viewer  :source="source" :thead="thead" :filter="filter" :create="create" :title="title" style="margin-top:63px">
        <template slot-scope="props">
          <tr @click="$router.push('/years/' + props.item.id)">
