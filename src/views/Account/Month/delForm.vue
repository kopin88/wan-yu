<template>
    ...
    <page-toolbar :title="'Create Income'"></page-toolbar>
			<v-ons-card style="margin-top:63px">
				...
				<v-ons-row class="mg-top-10">
					<v-ons-col>
						<v-ons-input placeholder="Name" v-focus="infocus" @focus="infocus = true" @blur="infocus = false" v-model="form.name" float style="width:100%;font-family:Zawgyi-One;"> </v-ons-input>
				...
				<v-ons-row class="mg-top-10">
					<v-ons-col>
						<v-ons-input type="number" placeholder="Amount" v-model="form.amount" float style="width:100%"> </v-ons-input>
				...
				<v-ons-row class="mg-top-10">
					<v-ons-col>
						<textarea class="textarea" rows="2" style="width:100%;font-family:Zawgyi-one;" placeholder="Description" float v-model="form.description"></textarea>
				...
				<v-ons-row class="mg-top-10">
					<v-ons-col>
						<textarea class="textarea" rows="2" style="width:100%;font-family:Zawgyi-one;" placeholder="Remark" float v-model="form.remark"></textarea>
